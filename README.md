...
<head>
    ...
    <title>Ufuk Can Demirsoy Portfolio</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="section">
            <h2>Courses</h2>
            <ul>
                <li>Machine Learning With Python (IBM, Jan 2023)</li>
                <li>Introduction to Deep Learning Neural Networks with Keras (IBM, Sep 2023)</li>
                <li>Building Deep Learning Models with TensorFlow (IBM, Feb 2024)</li>
        ...
        <div class="section">
            ...
            <ul>
                <li>
                    <strong>Sentiment Analysis (TR):</strong> I developed an application that performs sentiment analysis on Turkish texts. The goal of this project is to classify sentiment in texts as positive, negative, or neutral.
                ...
                <li>
                    ...
                    <br><strong>Technologies:</strong> Python, Graph/Optimization Algorithms
                    <br><strong>Details:</strong> Focuses on optimization algorithms and data visualization.
                    <br><strong>Achievements:</strong> My knowledge of algorithms and optimization processes allowed me to address real‑world problems in this project. I learned how to apply algorithms in a practical setting, such as route optimization using geographical data.
                    <br><a href="https://github.com/UfukCanDemirsoy/TRPathOptimizer" target="_blank">GitHub Link</a>
                </li>
                <li>
