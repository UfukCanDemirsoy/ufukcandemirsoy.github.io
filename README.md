...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <ul>
                <li>
                    <strong>Sentiment Analysis (TR):</strong> Application for classifying Turkish texts as positive, negative, or neutral.
                ...
                <li>
                    <strong>Face Recognition Chatbot v2 (Ongoing):</strong> Voice-enabled chatbot with real-time face recognition.
                ...
                <li>
                    <strong>TRPathOptimizer:</strong> Algorithm to calculate the shortest path between two points on the map of Turkey.
                ...
                <li>
                    <strong>Face Recognition Chatbot:</strong> The first version of a voice-enabled chatbot with face recognition.
